...
class IReLeaSE(Trainer):
    ...
    def initialize(hparams, demo_data_gen, unbiased_data_gen, prior_data_gen, *args, **kwargs):
        ...
        true_reward_func = get_jak2_min_baseline_reward if hparams['baseline_reward'] else get_jak2_min_reward
...
def main(flags):
    ...
    sim_label = flags.exp_name + '_min_IReLeaSE-PPO_' + (
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_model',
                        type=str,
                        default=None,
                        help='The name of the pretrained agent/generator model')
    parser.add_argument('--reward_model',
                        type=str,
                        default=None,
                        help='The name of the pretrained reward function')
